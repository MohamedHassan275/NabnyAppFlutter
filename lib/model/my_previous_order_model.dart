class MyPreviousOrderModel {
  bool? success;
  List<PreviousOrder>? previousOrder;
  String? message;

  MyPreviousOrderModel({this.success, this.previousOrder, this.message});

  MyPreviousOrderModel.fromJson(Map<String, dynamic> json) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.previousOrder != null) {
      myOrderResponseModel['data'] = previousOrder!.map((e) => e.toJson()).toList();
    }
